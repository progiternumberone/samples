...
module.exports = function(config) {
  config.set({
    ...
    files: [	
		...
		,{pattern: 'test/jasmine/ui/*.html', included: false}
		,{pattern: 'test/jasmine/ui/controls/*.html', included: false}
		,{pattern: 'test/jasmine/ui/layout.js', included: false}
		,{pattern: 'test/jasmine/*Spec.js', included: false}
		,{pattern: 'test/jasmine/specs/*Spec.js', included: false}
		,'test/jasmine/requireConf.js'
    ],
